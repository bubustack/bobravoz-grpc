...
- `docs/streaming/streaming-contract.md` — Streaming message contract, ordering, control semantics
- `docs/streaming/transport-settings.md` — Backpressure, routing, replay, partitioning, recording
