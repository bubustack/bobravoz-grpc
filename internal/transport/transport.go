...
var (
	...
	transportBuilders = make(map[string]Builder)
)

// Register adds a new transport builder to the registry. It is safe to call
// from init() functions; a sync.RWMutex protects against concurrent access.
