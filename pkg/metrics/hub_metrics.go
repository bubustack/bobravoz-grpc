...
var (
	...
	// messagesReceivedCounter tracks total messages received by the hub from upstream engrams
	messagesReceivedCounter = prometheus.NewCounterVec(
		prometheus.CounterOpts{
			Name: "bobravoz_grpc_messages_received_total",
			Help: "Total number of messages received by the hub from upstream engrams",
		},
		[]string{"storyrun", "step"},
	)

	// messagesSentCounter tracks total messages sent by the hub to downstream engrams
	messagesSentCounter = prometheus.NewCounterVec(
		prometheus.CounterOpts{
			Name: "bobravoz_grpc_messages_sent_total",
			Help: "Total number of messages successfully sent by the hub to downstream engrams",
		},
		[]string{"storyrun", "step"},
	)
